...
HI_S32 SAMPLE_VENC_H264(void)
{
    HI_S32 s32Ret;
    SIZE_S stSize;
    PIC_SIZE_E enSize = gParamOption.videoSize;//6946 PIC_400X400
    VENC_CHN VencChn = 0;
    HI_U32 u32Profile = 0;  // H.264: 0:baseline; 1:MP; 2:HP; 3:SVC-T ; H.265: 0:MP; 1:Main 10 [0 1];
    PAYLOAD_TYPE_E enPayLoad = gParamOption.videoFormat;//PT_H264
                ...
                if (FD_ISSET(VencFd[i], &read_fds)) {
                    ...
                    *******************************************************/
                    ...
                    if (gParamOption.mode == MODE_FILE) {
                        s32Ret = Hilive_COMM_VENC_SaveStream(pFile[i], &stStream);
